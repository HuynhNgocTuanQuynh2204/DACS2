...
$now = Carbon::now('Asia/Ho_Chi_Minh')->format('Y-m-d H:i:s');
   ...
   //them
    $sql_them = "INSERT INTO tbl_tailieu(tentailieu,hinhanh,link,ngaydang) VALUE('".$tentailieu."
      ','".$hinhanh_time."','".$link."','".$now."')";
   ...
   header('location:../../index.php?action=tailieu&query=them');
      ...
      if($hinhanh !=''){
         ...
         $sql_update = "UPDATE tbl_tailieu SET tentailieu='". $tentailieu."',
          hinhanh='". $hinhanh_time."',link='". $link."',ngaydang ='".$now."'
         ...
         $sql_update = "UPDATE tbl_tailieu SET tentailieu='". $tentailieu."',link='".$link."',ngaydang = '".$now."'
          WHERE id_tailieu='$_GET[idsanpham]'";
      }
