...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto"> 
      ...
      <li class="nav-item active">
        <a class="nav-link" href="index.php?action=quanlydanhmucsanpham&query=them">Danh mục khóa học</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="index.php?action=quanlysp&query=them">Khóa học</a>
      </li>
      <li class="nav-item active">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="index.php?action=danhmucsach&query=them">Danh mục sách</a>
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="index.php?action=sach&query=them">Sách</a>
      </li>
       <li class="nav-item active">
        <a class="nav-link" href="index.php?action=tailieu&query=them">Tài liệu</a>
      </li>
      <li class="nav-item active">
